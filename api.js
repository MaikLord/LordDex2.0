const fetchPokemon = (name) => {
  ...
  fetch(pokemonUrl + param)
    ...
    .then((pokemon) => {
      ...
      switch (true) {
        case HP >= 0 && HP <= 40:
          document.getElementById("st1").style.backgroundColor = "#e84443";
        ...
        default:
          switch (true) {
            case HP >= 41 && HP <= 104:
              document.getElementById("st1").style.backgroundColor = "#4B6AB3";
              document.getElementById("st1").style.transition = "0.5s";
              document.getElementById("st1").style.color = "white";
      ...
      switch (true) {
        case ATK >= 0 && ATK <= 40:
          document.getElementById("st2").style.backgroundColor = "#e84443";
        ...
        default:
          switch (true) {
            case ATK >= 41 && ATK <= 90:
              document.getElementById("st2").style.backgroundColor = "#4B6AB3";
              document.getElementById("st2").style.transition = "0.5s";
              document.getElementById("st2").style.color = "white";
      ...
      switch (true) {
        case DEF >= 0 && DEF <= 40:
          document.getElementById("st3").style.backgroundColor = "#e84443";
        ...
        default:
          switch (true) {
            case DEF >= 41 && DEF <= 80:
              document.getElementById("st3").style.backgroundColor = "#4B6AB3";
              document.getElementById("st3").style.transition = "0.5s";
              document.getElementById("st3").style.color = "white";
      ...
      switch (true) {
        case SPA >= 0 && SPA <= 40:
          document.getElementById("st4").style.backgroundColor = "#e84443";
        ...
        default:
          switch (true) {
            case SPA >= 41 && SPA <= 80:
              document.getElementById("st4").style.backgroundColor = "#4B6AB3";
              document.getElementById("st4").style.transition = "0.5s";
              document.getElementById("st4").style.color = "white";
      ...
      switch (true) {
        case SPD >= 0 && SPD <= 40:
          document.getElementById("st5").style.backgroundColor = "#e84443";
        ...
        default:
          switch (true) {
            case SPD >= 41 && SPD <= 80:
              document.getElementById("st5").style.backgroundColor = "#4B6AB3";
              document.getElementById("st5").style.transition = "0.5s";
              document.getElementById("st5").style.color = "white";
      ...
      switch (true) {
        case Speed >= 0 && Speed <= 35:
          document.getElementById("st6").style.backgroundColor = "#e84443";
        ...
        default:
          switch (true) {
            case Speed >= 36 && Speed <= 85:
              document.getElementById("st6").style.backgroundColor = "#4B6AB3";
              document.getElementById("st6").style.transition = "0.5s";
              document.getElementById("st6").style.color = "white";
